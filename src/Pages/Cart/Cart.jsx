...
// import { DataContext } from "../../Components/DataProvider/Dataprovider";
// import styles from "./Cart.module.css";
// import CurencyFormat from "../../Components/CurrencyFormat/CurencyFormater";
// import { Link } from "react-router-dom";
// import { Rating } from "@mui/material";
...
//                     </div>
//                     <p className={styles.cart_item_price}>
//                       Price: <CurencyFormat amount={item.price} />
//                     </p>
//                   </div>
//                 </div>
//               ))
...
//           <div className={styles.cart_summary}>
//             <h3>
//               Subtotal ({basket.length} items): <CurencyFormat amount={total} />
//             </h3>
//             <div className={styles.cart_gift}>
//               <input type="checkbox" id="gift" />
//               <label htmlFor="gift">This order contains a gift</label>
